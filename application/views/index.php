          ...
          <div class="navbar-end">
            <div class="navbar-item">
              ...
              <div style="padding-left: 30px;" class="buttons">
                <a href="<?= base_url('Welcome/register') ?>" class="button is-primary" style="padding: 0px 25px 0px 25px; background-color: #B09B71;">
                  <strong>Daftar</strong>
                </a>
                <a href="<?= base_url('Welcome/login') ?>" class="button is-light" style="padding: 0px 25px 0px 25px;">
                  Masuk
                </a>
              </div>
            </div>
