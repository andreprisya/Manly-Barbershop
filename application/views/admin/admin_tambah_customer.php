                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Tambah Data Customer</h3>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                ...
                <div class="row align-item-center">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('auth/cek_regis2') ?>" method="POST">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="file" id="foto_profil" name="foto_profil" multiple required>
                                        </div>
                                    </div>
