                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Tambah Data Reservasi</h3>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">Data Reservasi</h6> 
                            </div>
                            <div class="card-body">
                                <form action="<?= base_url('auth/cek_regis4') ?>" method="POST">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <label for="id_services" class="form-label">ID Services</label>
                                            <input type="text" class="form-control" id="id_services" name="id_services" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">ID Stylist</label>
                                            <input type="text" class="form-control" id="id_stylist" name="id_stylist" required>
                                        </div>
                                        <div class="col-md-6">
