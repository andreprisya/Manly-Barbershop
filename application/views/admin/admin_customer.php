                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <a href="<?= base_url('admin/admin_tambah_customer') ?>" style="color: white; margin-left: auto;" type="button" class="btn btn-success">+ Tambah Customer</a>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                    ...
                                    <table id="patient-table" class="table table-hover align-middle mb-0" style="width: 100%;">
                                        ...
                                        <?php foreach ($customer as $us): ?>
                                            <tr>
                                                ...
                                                <td><?= $us['alamat']; ?></td>
                                                <td>
                                                <a type="button" href="<?= base_url('admin/ubah_customer/') . $us['id_user']; ?>" class="btn btn-secondary">Update</a>
                                                <a type="button" href="<?= base_url('admin/hapus/') . $us['id_user']; ?>" class="btn btn-danger">Delete</a>
                                                </td>
