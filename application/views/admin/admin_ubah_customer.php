                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Update Data Customer</h3>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                                ...
                                <form action="<?= base_url('admin/edit')?>" method="POST">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" value="<?= $customer['nama']; ?>" class="form-control" id="nama" name="nama" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="alamat" class="form-label">Alamat</label>
                                            <input type="text" value="<?= $customer['alamat']; ?>" class="form-control" id="alamat" name="alamat" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Nomor Handphone</label>
                                            <input type="text" value="<?= $customer['no_hp']; ?>" class="form-control" id="no_hp" name="no_hp" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Username</label>
                                            <input type="text" value="<?= $customer['username']; ?>" class="form-control" id="username" name="username" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Password</label>
                                            <input type="password" value="<?= $customer['password']; ?>" class="form-control" id="password" name="password" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="foto_profil" class="form-label"> File Upload</label>
                                            <input class="form-control" value="<?= $customer['foto_profil']; ?>" type="file" id="foto_profil" name="foto_profil" multiple required>
                                        </div>
                                    </div>
